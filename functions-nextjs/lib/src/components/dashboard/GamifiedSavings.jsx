...
const GamifiedSavings = ({ savingsGoals, handleReceiptUpload }) => {
    return (<div className="bg-white shadow-md rounded-lg p-6">
      ...
      <div className="space-y-4">
        {savingsGoals.map((goal) => (<div key={goal.name} className="bg-blue-50 p-4 rounded-md shadow-sm">
      ...
      <div className="mt-6">
       ...
       <div className="mt-6">
          <button onClick={handleReceiptUpload} className="w-full bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">
...
exports.default = GamifiedSavings;
//# sourceMappingURL=GamifiedSavings.jsx.map