...
const SpendingOverview = ({ spendingData, totalSpending, totalSavings, projectedSavings }) => {
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
        ...
        <div className="relative w-40 h-40 sm:w-48 sm:h-48 flex-shrink-0">
          <svg viewBox="0 0 100 100" className="w-full h-full">
            ...
            <circle cx="50" cy="50" r="45" fill="transparent" stroke="#EF4444" strokeWidth="10" strokeDasharray="25 75" // 25% of circle
     strokeDashoffset="0" transform="rotate(-90 50 50)"/>
             <circle cx="50" cy="50" r="45" fill="transparent" stroke="#3B82F6" strokeWidth="10" strokeDasharray="10 90" // 10% of circle
     strokeDashoffset="-25" // Offset by previous segment
     transform="rotate(-90 50 50)"/>
             <circle cx="50" cy="50" r="45" fill="transparent" stroke="#10B981" strokeWidth="10" strokeDasharray="11 89" // 11% of circle
     strokeDashoffset="-35" // Offset by previous segments
     transform="rotate(-90 50 50)"/>
             <circle cx="50" cy="50" r="45" fill="transparent" stroke="#6B7280" strokeWidth="10" strokeDasharray="25 75" // 25% of circle
     ...
     transform="rotate(-90 50 50)"/>
        ...
        <div className="flex-grow w-full">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {spendingData.map((item, index) => (<div key={index} className="flex items-center space-x-2 p-2 bg-gray-50 rounded-md shadow-sm">
...
exports.default = SpendingOverview;
//# sourceMappingURL=SpendingOverview.jsx.map